...
export function PropertyContracts() {
  ...
  return (
    <div className="space-y-3 rounded-xl bg-zinc-800 text-zinc-50 lg:space-y-5">
                ...
                <tr key={contract.id} className="p-5 text-center">
                  ...
                  <td className="space-y-3 p-3">
                    <Button
                      ...
                      onClick={() => {
                        router.push(`/back-office/contracts/${contract.id}`)
                      }}
                    >
                      Detalhes
                    </Button>
                    <Button
                      ...
                      onClick={() => {
                        router.push(
                          `/back-office/contracts/update/${contract.id}`,
                        )
                      }}
                    >
                      Editar
